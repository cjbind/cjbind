...
HEADERS = [
    ...
    ROOT / "cjbind_test/testdata/headers/anonymous-template-types.hpp",
    ROOT / "cjbind_test/testdata/headers/default-template-parameter.hpp",
    ROOT / "cjbind_test/testdata/headers/empty_template_param_name.hpp",
    ROOT / "cjbind_test/testdata/headers/inner-typedef-gh422.hpp",
    ROOT / "cjbind_test/testdata/headers/inner_template_self.hpp",
    ROOT / "cjbind_test/testdata/headers/issue-1113-template-references.hpp",
    ROOT / "cjbind_test/testdata/headers/issue-820-unused-template-param-in-alias.hpp",
    ROOT / "cjbind_test/testdata/headers/nested-template-typedef.hpp",
    ROOT / "cjbind_test/testdata/headers/opaque-template-inst-member-2.hpp",
    ROOT / "cjbind_test/testdata/headers/opaque-template-inst-member.hpp",
    ROOT / "cjbind_test/testdata/headers/opaque-template-instantiation-namespaced.hpp",
    ROOT / "cjbind_test/testdata/headers/template-with-var.hpp",
    ROOT / "cjbind_test/testdata/headers/template_alias.hpp",
    ROOT / "cjbind_test/testdata/headers/template_alias_basic.hpp",
    ROOT / "cjbind_test/testdata/headers/template_alias_namespace.hpp",
    ROOT / "cjbind_test/testdata/headers/template_typedef_transitive_param.hpp",
    ROOT / "cjbind_test/testdata/headers/template_typedefs.hpp",
    ROOT / "cjbind_test/testdata/headers/templateref_opaque.hpp",
    ROOT / "cjbind_test/testdata/headers/union_template.hpp",
    ROOT / "cjbind_test/testdata/headers/variadic_template_function.hpp",
]
